          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-[14px] lg:text-sm leading-relaxed">
                ...
                Надішліть їх нам! Ми виготовимо акумулятор будь-якої конфігурації з ваших осередків, 
                використовуючи професійне обладнання.
              </p>
              ...
              >
                <p className="text-sm leading-relaxed">
                  Вартість цього товару починається від{" "}
                  <span className="font-semibold text-white">1300 грн</span>. 
                  Точна ціна визначається індивідуально відповідно до ваших потреб. 
