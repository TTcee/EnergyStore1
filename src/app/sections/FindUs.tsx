...
export default function FindUs() {
  return (
    ...
    <img src="/shademain2.png" alt="Моє зображення" className="absolute w-150 z-[-9] ml-300 hidden " />
    <img src="/shademain2.png" alt="Моє зображення" className="absolute w-200 z-[-9] ml-[-200] mt-70" />
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-2 lg:gap-12">
        ...
        <div className="space-y-6">
          ...
          <hr className="border-white border-[1.5px] w-85 sm:md md:md md:w-[80%]" />
        ...
        >
          <iframe
            ...
            className="w-85 ml-25 h-full rounded-lg shadow-lg sm:w-2xl sm:ml-[-40] md:w-[110%] md:ml-10 lg:w-2xl"
            style={{ border: 0 }}
            loading="lazy"
          ></iframe>
        </div>
